...
| Area                          | Decision                                                                                                                                                                                                                                          |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App showcase screenshots      | Considered and refused. Four screenshots per app is roughly 1MB per entry against single-digit MB of headroom under the 100MB cap. `src/lib/showcase/icon.ts` refuses one with a message that says so. `docs/app-showcase.md` has the measurement |
